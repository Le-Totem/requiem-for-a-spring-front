...
interface NoteProps {
    ...
    label: string;
    xtext: number;
    iconType: "blanche" | "clef" | "croche" | "doubleNoire" | "fa" | "ut" | "doubleSharp" | "soupir";
    isOnStaff: boolean;
    onClick?: () => void;
    size?: number
}
 ...
 * 
 */
export const Note = ({ x, y, label, xtext, iconType, onClick, isOnStaff = false }: NoteProps) => {
