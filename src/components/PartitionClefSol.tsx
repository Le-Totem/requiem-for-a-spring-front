...
const Partition: React.FC = () => {
    ...
    // Variables pour la gestion de la taille de la portée
    const paddingY = 12;
    const lineGap = 12;
    const numberOfLines = 5;

    // Variables pour la gestion de la taille de la clef
    ...
    useEffect(() => {
        ...
        const handleResize = () => {
            ...
            // Mise à jour dynamique de la clef
    ...
    return (
        ...
        >
            <svg
                ...
                style={{ width: '100%', height: '100%', display: 'block', justifyContent: "center" }}
            >
                {/* Rectangle de fond */}
                ...
                <ClefSol x={clefX} y={clefY} size={clefSize} color="#75541C" />
